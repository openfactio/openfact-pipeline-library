...
def tagDownstreamRepos() {
    ...
    setWorkspace('openfactio/openfact-pipeline-library')
    ...
    git 'https://github.com/openfactio/openfact-jenkinsfile-library.git'
    setWorkspace('openfactio/openfact-jenkinsfile-library')
